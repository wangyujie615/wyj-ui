...
4. 树形节点实现异步加载功能
    ...
    - 异步加载节点的异步函数由外部控制，外部传入一个Promise函数，控制节点的数据
    - 
5. 实现禁用节点
